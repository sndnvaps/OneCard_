...
namespace Common
{
    public class General
    {
        ...
        /// <param name="sourceObject">数据源对象</param>
        /// <returns></returns>
        public static List<TResult> ReturnList<TSource, TResult>(IEnumerable<TSource> sourceObject)
        {
            TResult infoObject = default(TResult);
            ...
            {
                foreach (TSource item in sourceObject)
                {
                    infoObject = Activator.CreateInstance<TResult>();

                    infoObject = CopyObjectValue<TSource, TResult>(item);

                    returnList.Add(infoObject);
                }
            }
        ...
        //public static List ReturnList<TSource, TResult>(List<TSource> sourceObject)
        //{
        //    //Type accessorType = Type.GetType(TSource, false);
        ...
        public static SystemLog.SystemLog BindDbLogInfo()
        {
            ...
            {
                strConn = @"Data Source=.;Initial Catalog=SIOTS_HHZXDB;User ID=sa;Password=!!!aaa111";
            }
