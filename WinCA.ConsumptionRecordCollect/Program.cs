    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine(getCWStyle("消费数据收集服务启动", SystemLog.SystemLog.LogType.Trace));
                ...
                bool blnRes = service.Collect();
                if (blnRes)
                    Console.WriteLine(getCWStyle("消费数据收集成功", SystemLog.SystemLog.LogType.Trace));
                else
                {
                    Console.WriteLine(getCWStyle("消费数据收集失败", SystemLog.SystemLog.LogType.Trace));
                ...
                Console.WriteLine(getCWStyle("消费数据收集服务完毕", SystemLog.SystemLog.LogType.Trace));
                //Console.ReadKey();
            }
            catch (Exception ex)
            {
