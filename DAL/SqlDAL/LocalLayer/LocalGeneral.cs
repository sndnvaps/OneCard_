...
namespace DAL.SqlDAL.LocalLayer
{
    class LocalGeneral
    {
        ...
        public static ReturnValueInfo LockRecord(string tableName, long recordID,string userID)
        {
            ...
            try
            {
                using (SIOTSDB_HHZXDataContext dbDataContext = new SIOTSDB_HHZXDataContext())
                {
                    recordInfo = dbDataContext.Sys_RecordLockRegister_rlr.SingleOrDefault<Sys_RecordLockRegister_rlr>(t => t.rlr_cTableName == tableName && t.rlr_iByLockRecordID == recordID);
                    ...
                    if (recordInfo == null)
                    {
                        ...
                        dbDataContext.Sys_RecordLockRegister_rlr.InsertOnSubmit(insertInfo);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                dbDataContext.Sys_RecordLockRegister_rlr.DeleteOnSubmit(recordInfo);
        ...
        /// <param name="userID">用户ID</param>
        /// <returns></returns>
        public static ReturnValueInfo UnLockRecord(SIOTSDB_HHZXDataContext dbDataContext, string tableName, long recordID, string userID)
        {
            ...
            try
            {
                recordInfo = dbDataContext.Sys_RecordLockRegister_rlr.SingleOrDefault<Sys_RecordLockRegister_rlr>(t => t.rlr_cTableName == tableName && t.rlr_iByLockRecordID == recordID && t.rlr_cLockedBy == userID);
