...
namespace DAL.IDAL.HHZX.ConsumeAccount
{
    ...
    /// </summary>
    public interface IRechargeRecordDA : IMainGeneralDA<RechargeRecord_rcr_Info>
    {
        /// <summary>
        /// 增减款明细
        /// </summary>
        ...
        /// 更新充值记录
        /// </summary>
        /// <param name="listRecord">需要更新的充值记录</param>
        /// <param name="fPreCostRecharge">充入的预付款充值额</param>
        /// <returns></returns>
