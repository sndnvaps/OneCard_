        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            try
            {
                ...
                if (this._UserInfo != null)
                {
                    ...
                    {
                        pcs_cUserID = this._UserInfo.cus_cRecordID
                    });

                    listPreCost = listPreCost.Where(x => x.pcs_lIsSettled == false && x.pcs_cConsumeType != Common.DefineConstantValue.ConsumeMoneyFlowType.HedgeFund.ToString() && x.pcs_cConsumeType != Common.DefineConstantValue.ConsumeMoneyFlowType.AdvanceMealCost.ToString()).ToList();
