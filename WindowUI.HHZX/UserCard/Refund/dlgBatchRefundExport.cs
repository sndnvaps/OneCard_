...
{
    public partial class dlgBatchRefundExport : BaseForm
    {
        ...
        private void ExportTemplate(string xlsSavePath)
        {
            ...
            try
            {
                ...
                excelUtil.Open(Application.StartupPath + "/ExcelTemplate/TransferBatchRefund.xls");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            dlgSaveFile.FileName = cbbTempleType.Text + "批量退款模板.xls";
