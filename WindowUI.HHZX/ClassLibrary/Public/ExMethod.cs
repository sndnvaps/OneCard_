...
namespace WindowUI.HHZX.ClassLibrary.Public
{
    public static class ExMethod
    {
        ...
        /// 下拉框高度
        /// </summary>
        private static int ComboboxItemHeight = 17;
        ...
        {
            SetComboBoxHeight(ctlComboBox, ComboboxItemHeight);
        ...
        /// <param name="ctlComboBox"></param>
        /// <param name="datasource">数据源</param>
        /// <param name="iComboboxItemHeight">数据行距</param>
        public static void SetDataSourceWithHeight(this ComboBox ctlComboBox, List<IModelObject> datasource, int iComboboxItemHeight)
        {
            SetComboBoxHeight(ctlComboBox, iComboboxItemHeight);
        ...
        private static void SetComboBoxHeight(ComboBox list, int itemHeight)
        {
            ...
            list.DrawItem += new DrawItemEventHandler(delegate(object sender, DrawItemEventArgs e)
            {
                ...
                ComboboxDataInfo dinfo = list.Items[e.Index] as ComboboxDataInfo;

                e.Graphics.DrawString(dinfo.DisplayMember.ToString(), e.Font, new SolidBrush(e.ForeColor), e.Bounds.X, e.Bounds.Y + 3);
            });
        }
        ...
        /// 设置控件数据源
        /// </summary>
        /// <param name="ctlListBox">控件对象</param>
        /// <param name="datasource">数据源</param>
        ...
        /// 设置控件数据源
        /// </summary>
        /// <param name="ctlComboBox">控件对象</param>
        /// <param name="datasource">数据源</param>
        ...
        public static void SetDataSource(this ComboBox ctlComboBox, List<IModelObject> datasource, int blankSpaceIndex)
        {
            ...
            Comboboxdatas.OrderByDescending(p => p.DisplayMember);
